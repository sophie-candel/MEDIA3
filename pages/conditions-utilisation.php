...
<body class="texte_fonce">
    ...
    <?php include("../includes/nav.php"); ?>
        ...
        <main>
            <section>
                <article>
                    <h1>Conditions générales d'utilisation du site droit-image.eu</h1>
                    <h3>ARTICLE 1 : Objet</h3>
                    <p> Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site droit-image.eu et leur utilisation par « l'Utilisateur ». Les conditions générales d'utilisation doivent être acceptées par tout Utilisateur souhaitant accéder au site. Elles constituent le contrat entre le site et l'Utilisateur. L’accès au site par l’Utilisateur signifie son acceptation des présentes conditions générales d’utilisation. </p>
                    <h3>ARTICLE 2 : Mentions légales</h3>
                    <p> Ce site est édité par Sophie Candel, Auryane Reisser et Timothé Golla Si vous voulez contacter l’un d’eux, merci d’envoyer un courriel sur droit-image@outlook.fr Le directeur de la publication est Mme Auryane Reisser L'hébergeur du site droit-image.eu est la Société OVH, Société par Actions Simplifiée au capital de 10 000 000 € dont le siège social est situé au 2 Rue Kellermann 59100 ROUBAIX, immatriculée au Registre du Commerce et des Sociétés sous le numéro: RCS ROUBAIX-TOURCOING B 424 761 419 </p>
                    ...
                    <p> Les informations demandées à l’inscription au site sont nécessaires et obligatoires pour la création du compte de l'Utilisateur. En particulier, l'adresse électronique pourra être utilisée par le site pour l'administration, la gestion et l'animation du service. En vertu des articles 39 et 40 de la loi en date du 6 janvier 1978, l'Utilisateur dispose d'un droit d'accès, de rectification, de suppression et d'opposition de ses données personnelles. L'Utilisateur exerce ce droit via : • son espace personnel ; • un formulaire de contact ; • par mail à droit-image@outlook.fr ; </p>
                    ...
                    <p> De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de droit-image.eu qui n'a pas le contrôle de ces liens. L'Utilisateur s'interdit donc à engager la responsabilité du site concernant le contenu et les ressources relatives à ces liens hypertextes sortants. </p>
                    ...
                    <p> La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux de la ville de Haguenau sont compétents. </p>
                </article>
            </section>
        </main>
        <!--FOOTER-->
