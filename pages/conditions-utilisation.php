...
<h>
Les présentes « conditions générales d'utilisation » ont pour objet l'encadrement juridique des modalités de mise à disposition des services du site droit-image.eu et leur utilisation par « l'Utilisateur ».
...
<h>
Ce site est édité par Sophie Candel, Auryane Reisser et Timothé Golla
Si vous voulez contacter l’un d’eux, merci d’envoyer un courriel sur droit-image@outlook.fr
Le directeur de la publication est Mme Auryane Reisser
L'hébergeur du site droit-image.eu est la Société OVH, Société par Actions Simplifiée au capital de 10 000 000 € dont le siège social est situé au 2 Rue Kellermann 59100 ROUBAIX, immatriculée au Registre du Commerce et des Sociétés sous le numéro:
...
•	articles d’information sur le droit à l’image en France et en Europe;
...
Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de droit-image.eu.
...
L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse droit-image@outlook.fr.
</h>
...
•	par mail à droit-image@outlook.fr ;
</h>
...
<h>
De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de droit-image.eu qui n'a pas le contrôle de ces liens.
...
<h>
La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un litige né entre les parties, seuls les tribunaux de la ville de Haguenau sont compétents.
</h>
